...
<link rel="stylesheet" href="{{asset('css/mintic.css')}}">
...
<main id="main" class="main">
    <div class="pagetitle text-center">
        <div >
            <h1>Cargue y Actualizacion</h1>
            <nav class="text-center">
                <ol class="breadcrumb d-inline-block">
                    <li class="breadcrumb-item d-inline-block" id="1"><a href="?id=1">Mapa de procesos</a></li>
                    <li class="breadcrumb-item d-inline-block" id="2"><a href="?id=2">Ultrabikes</a></li>
                    <li class="breadcrumb-item d-inline-block" id="3"><a href="?id=3">Identidad corporativa</a></li>
                    <li class="breadcrumb-item d-inline-block" id="4"><a href="?id=4">Noticias</a></li>
                    <li class="breadcrumb-item d-inline-block" id="5"><a href="?id=5">Links</a></li>
                    <li class="breadcrumb-item d-inline-block" id="4"><a href="?id=6">Registro de Usuarios</a></li>
                </ol>
            </nav>
        </div>
    @if (count($errors) > 0)
            ...
            <div class="tab-pane shadow-lg rounded bg-white p-5 mt-3" style="height: 270px; text-align: justify; text-justify: auto; border:2px solid #f37531b4">
                ...
                <form class="formulario" action="{{route('iden', 'somos')}}" method="post">
                    ...
                    <div class="row align-items-center">
                        <div class="col-10">
                            <textarea name="descripcion" class="text-mutedresources/views/administracion/cargar.blade.php mb-2" style="height: 95px; width: 100%">{{ $somos }}</textarea>
                        </div>
                        <div class="col">
    ...
    @endif
     ...
     @if (Auth::user()->id_unidad == 1 || Auth::user()->id_rol == 3 || Auth::user()->id_unidad == 7)
        ...
        <meta name="csrf-token" content="{{ csrf_token() }}" />
        <div class="container mx-auto tab-pane shadow rounded bg-white p-5 mt-4">
            <h2 class="head fw-bold mb-5">Eliminar Links</h2>
            {{-- <p hidden>Clicks: <a id="clicks">0</a></p>
            <a class="text-primary text-decoration-none" id="nuevo-link" onClick="countClick()">
                <i class="bi bi-plus-circle text-primary fs-4"></i> Agregar Fila
            </a> --}}
                        ...
                        <div class="input-field">
                            ...
                            <select name="id_unidad" id="choice2">
                                ...
                                @foreach ($unidades as $unidad)
                                    ...
                                    @endif
                                    @if ($unidad->id == 1 || $unidad->id == 8 || $unidad->id == 9 || $unidad->id >= 10 && $unidad->id <= 18)
