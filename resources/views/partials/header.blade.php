...
<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <a href="{{ route('index') }}" class=" d-flex align-items-center">
            ...
            <span class="d-none d-lg-block ms-2"><img src="{{ asset('/storage/logos/name.png') }}"
        ...
        <ul class="d-flex align-items-center">
            <li class="nav-item dropdown pe-3">
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                    <img src="
                        @if (Auth::user()->foto == null) {{ asset('storage/usuarios/usuario.png') }}
                        @else
                            {{ asset(Auth::user()->foto) }} @endif
                    "
                    ...
                    <li>
                        <form action="{{ route('logout') }}" method="POST">
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#"
                                onclick="this.closest('form').submit()" name="cerrarSesion">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-check-square fs-6"></i><span class="fs-6">SIG</span><i
            ...
            <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                ...
                @if (Auth::user()->id_rol != 4)
                    ...
                    <li>
                        {{-- <a href="{{route('gestor.permisos')}}">
                            <i class="bi bi-circle"></i>
                            <span>Gesti n de Solicitudes de Permisos</span>
                        </a> --}}
                    </li>
                @endif
                @if (Auth::user()->id_unidad >= 7 && Auth::user()->id_unidad < 26)
                    <li>
                        <a href="{{ route('links') }}">
                            <i class="bi bi-circle"></i>
                            <span>Links</span>
                ...
                @elseif(Auth::user()->id_unidad == 1 || Auth::user()->id_unidad == 4 || Auth::user()->id_unidad == 27)
                    <li>
                        <a href="{{ route('links') }}">
                            <i class="bi bi-circle"></i>
                            <span>Links</span>
                ...
                @elseif(Auth::user()->id_unidad == 2 || Auth::user()->id_unidad == 3 || Auth::user()->id_unidad == 27)
                    <li>
                        <a href="{{ route('links') }}">
                            <i class="bi bi-circle"></i>
                            <span>Links</span>
                ...
                @elseif(Auth::user()->id_rol == 1 || Auth::user()->id_unidad == 26 || Auth::user()->id_unidad == 27)
                    <li>
                        <a href="{{ route('links') }}">
                            <i class="bi bi-circle"></i>
                            <span>Links</span>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#gh" data-bs-toggle="collapse" href="#">
                <i class="bi bi-people fs-6"></i><span class="fs-6">Gestion Humana</span><i
                    class="bi bi-chevron-down ms-auto"></i>
            </a>
        </li>
        <ul id="gh" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            ...
            <li>
                ...
                {{-- Solo los usuarios autenticados que complan con la condicion podran gestionar la aprobaci n de permisos --}}

                @if (Auth::user()->id_unidad == 4 ||
                        Auth::user()->id_unidad == 1 ||
                        Auth::user()->id_unidad == 2 ||
                        Auth::user()->id_rol == 2 ||
                        Auth::user()->id_rol == 3)
                    <a href="{{ route('consultar-permisos') }}">
                        <i class="bi bi-circle"></i>
                        <span>Aprobacion de Permisos</span>
                ...
                @if (Auth::user()->id_unidad == 4 ||
                    Auth::user()->id_rol == 1
 || Auth::user()->id_rol == 5)
                    <a href="{{ route('permisos.seguimiento') }}">
                        <i class="bi bi-circle"></i>
                        <span>Seguimiento de Permisos</span>

                    </a>
                @endif
            </li>
@if( (Auth::user()->id_rol == 2 && Auth::user()->id_unidad == 4)
      || Auth::user()->id_rol == 4
      || Auth::user()->id_rol == 1 )
    <a href="{{ route('horarios.index') }}">
        <i class="bi bi-circle"></i>
        <span>Cambio de Horario</span>
    </a>
@endif
            @if (
                (Auth::user()->id_rol == 2 && Auth::user()->id_unidad == 4) ||
                    (Auth::user()->id_rol == 2 && Auth::user()->id_unidad == 7) ||
                    Auth::user()->id_rol == 1 ||
                    Auth::user()->id_rol == 5)
                <a href="{{ route('aprobacion.horarios') }}">
                    <i class="bi bi-circle"></i>
                    <span>Aprobacion de Horario</span>
                </a>
            @endif
        ...
        @if (Auth::user()->id_rol != 4)
            @if (Auth::user()->id_unidad == 1 || Auth::user()->id_unidad == 26)
                <li class="nav-item">
        ...
        @endif
        @if (Auth::user()->id_rol == 3 || Auth::user()->id_rol == 2 || Auth::user()->id_unidad == 7)
            <li class="nav-item">
                <a class="nav-link" href="{{ route('administrar-mapa') }}">
                    <i class="bi bi-upload"></i>
        ...
        @endif --}}
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#trayectoria-nav" data-bs-toggle="collapse"
                    href="javascript:void(0)">
                    <i class="bi bi-people fs-6"></i><span class="fs-6">Trayectoria Formativa</span>
                    <i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="trayectoria-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">

                    <li>
                        <a href="{{ route('trayectoria.index') }}"><span>Calificacion</span></a>
