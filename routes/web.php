...
Route::post('/noticias2/{name}', [MapaController::class, 'modificar'])->name('noticias2.updateTexto');
...
Route::post('/permisos/{id}/marcar-proceso', [PermisosController::class, 'marcarEnProcesoYNotificar253'])
    ->name('permisos.marcarProceso');

Route::post('/permisos/{id}/marcar-recibido', [PermisosController::class, 'marcarRecibidoPor253'])
    ->name('permisos.marcarRecibido');
//Horarios
Route::get('/horarios', [HorariosController::class, 'index'])->name('horarios.index');

Route::get('/listahorarios', [HorariosController::class, 'listado'])->name('listado.horarios');

Route::get('/horarios/{horario}/json', [HorariosController::class, 'showJson'])->name('horarios.show.json');

Route::post('/horarios/{horario}',      [HorariosController::class, 'update']);

Route::post('/horarios', [HorariosController::class, 'store'])->name('horarios.store');

Route::post('/horarios/{id}/soporte', [HorariosController::class, 'subirSoporte'])
    ->name('horarios.subirSoporte');
//Aprobacion de Horarios
Route::get('/AprobacionHorarios', [HorariosController::class, 'permisoHorario'])
    ->name('aprobacion.horarios');
// routes/web.php

Route::get('/intranet/versoporte/{id}/descargar', [HorariosController::class, 'descargarSoporte'])
    ->name('descargarsoporte');

Route::put('/horarios/{id}/estado', [HorariosController::class, 'actualizarEstado'])->name('horarios.actualizarEstado');

Route::patch('/horarios/{id}/eliminar', [HorariosController::class, 'eliminarPermisoHorario'])->name('horarios.eliminarPermisoHorario');

// L�gica para la aprobaci�n de horarios
Route::post('/horarios/{horario}/aprobar', [HorariosController::class, 'aprobar'])
    ->name('horarios.aprobar');


// Eliminar solicitus
Route::post('/horarios/{id}/eliminar', [HorariosController::class, 'eliminarSolicitud'])
    ->name('horarios.eliminar');
    //Trayectoria formativa
Route::get('/trayectoria', [TrayectoriaController::class, 'index'])->name('trayectoria.index');
Route::get('/trayectoria/modal/calificar',[TrayectoriaController::class, 'modalCalificarPartial'])->name('trayectoria.modal.calificar');
Route::get('/trayectoria/{id}/calificar', [TrayectoriaController::class, 'calificar'])->whereNumber('id')->name('trayectoria.calificar');
Route::get('/diag/trayectoria/ping', [TrayectoriaController::class, 'pingDb']);

Route::post('/trayectoria/calificar/guardar', [TrayectoriaController::class, 'guardarCalificacion'])
    ->name('trayectoria.calificar.guardar');
